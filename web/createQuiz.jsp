<%-- 
    Document   : createQuiz
    Created on : May 29, 2020, 9:10:27 AM
    Author     : KRIS
--%>
    ...
    <body onload="checkStatus()">
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form class="contact100-form validate-form" action="QuestionMainController" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Question ID is required">
                        <label class="label-input100" for="name">ID</label>
                        <input id="id" class="input100" type="text" name="txtId" value="${requestScope.QUESTION.id}">
                    ...
                    <input type="hidden" name="txtChoice" value="Question Name"/>
        ...
        <script>
            function checkId() {
                ...
                var idValidation = /^[0-9]+$/;
                if (id.length > 0 && !idValidation.test(id)) {
